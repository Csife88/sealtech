...
public class QantityCount {
	...
	public int sendHeatQuntityCount(JComboBox<String> combo) { //  h�kezelben l�v� mennyis�gek sz�ml�l�sa 
	...
	public int arrivedHeatQuntityCount(JComboBox<String> combo) { //  h�kezelb�l vissza�rkezett mennyis�gek sz�ml�l�sa 
