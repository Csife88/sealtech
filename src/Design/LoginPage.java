...
public class LoginPage extends JFrame {
	...
	private Image img_logo = new ImageIcon(LoginPage.class.getResource("img/main.png")).getImage().getScaledInstance(130, 130, Image.SCALE_SMOOTH);
	private Image img_lakat = new ImageIcon(LoginPage.class.getResource("img/lakat.png")).getImage().getScaledInstance(60, 60, Image.SCALE_SMOOTH);
	...
	public LoginPage() {
		...
		loginBtn.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				String Query = "select * from pls.admin where AdminName='"+UID.getText()+"' and AdminPass='"+uPass.getText()+"'";
				try {
					con = DriverManager.getConnection("jdbc:mysql://database-1.c3byo1nvyfgl.eu-central-1.rds.amazonaws.com", "admin", "Szemes1!");
